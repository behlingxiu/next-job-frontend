<script>
    ...
    async function createJob(evt) {
      ...
      if (res.status == 200){
        ...
        // toast.push(resp.message) // this causes error. no variable toast. hint: look at /src/routes/users/new/+page.svelte to check how we handle form errors
    ...
    <div class="flex justify-center items-center mt-5">
        <form on:submit={createJob} class="w-4/5">
            <div class="form-control w-full">
                ...
                <input type="text" name="jobTitle" placeholder="Software Engineer" class="input input-bordered w-full" />
            ...
            <div class="form-control w-full">
                ...
                <input type="text" name="companyName" placeholder="e.g. Facebook" class="input input-bordered w-full" />
            ...
            <div class="form-control w-full">
                ...
                <input type="text" name="jobLocation" placeholder="e.g. Singapore" class="input input-bordered w-full" />
            ...
            <div class="form-control w-full">
                ...
                <textarea name="description" class="input input-bordered w-full h-60"></textarea>
            ...
            <div class="form-control w-full">
                ...
                <textarea name="requirements" class="input input-bordered w-full h-60"></textarea>
            ...
            <div class="form-control w-full">
                ...
                <textarea name="applicationInstructions" class="input input-bordered w-full h-40"></textarea>
